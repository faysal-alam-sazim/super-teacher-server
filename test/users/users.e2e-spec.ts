      ...
      it("returns OK(200) with updated student profile data", async () => {
        ...
        request(httpServer)
          ...
          .expect((response) => {
            ...
            expect(data.student).toHaveProperty(
              "educationLevel",
              updatedStudent.studentInput.educationLevel,
            );
            expect(data.student).toHaveProperty("class", updatedStudent.studentInput.class);
          });
      });
      ...
      it("returns OK(200) with updated student profile data", async () => {
        ...
        request(httpServer)
          ...
          .expect((response) => {
            ...
            expect(data.teacher).toHaveProperty(
              "majorSubject",
              updatedTeacher.teacherInput.majorSubject,
            );
          });
      });
