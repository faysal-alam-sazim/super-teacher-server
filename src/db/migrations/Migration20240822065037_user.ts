...
export class Migration20240822065037_user extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "teachers" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "highest_education_level" varchar(255) not null, "major_subject" varchar(255) not null, "subjects_to_teach" varchar(255) not null, "user_id" int not null);',
    );
    this.addSql(
