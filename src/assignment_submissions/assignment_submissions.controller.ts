...
export class AssignmentSubmissionsController {
  ...
  async getAssignmentSubmissions(@Param("assignmentId", ParseIntPipe) assignmentId: number) {
  ...
  addSubmission(
    ...
    return this.assignmentSubmissionsService.addSubmission(assignmentId, file, user.id);
  }
}
